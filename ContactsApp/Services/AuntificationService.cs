...
public class AuntificationService : IAuntificationService
{
    ...
    /// </summary>
    /// <param name="sessionToken">Token generated by LoginAsync</param>
    /// <param name="httpContextRequestAborted">Request cancellation token</param>
    /// <exception cref="ArgumentException">If session token is invalid</exception>
